...
/***********
 * This class is for learning about how a Java programmer would implement a bitcoin address generator
 * class in java. This requires the bouncycastle library.
 * @author Gweedo
 *
 */
public class BitcoinAdress {
...
private byte[][] ECDSAgeneratePublicAndPrivateKey(){
	...
	publickey[0]=4;
	return new byte[][]{privatekey.getD().toByteArray(),publickey};
}
/************
 ...
 * key in WIF, the third element is the bitcoin address.
 * @return
 */
